                                        ...
                                        <div className="col-md-6 col-lg-4">
                                            <div className="property-agent">
                                                ...
                                                <p className="color-text-a">
                                                    Phòng luôn chất lượng đảm
                                                    bảo đúng sự thật và không
                                                    các chi tiết khiến người
                                                    dùng thất vọng khi đến xem
                                                    và kiểm tra phòng. An ninh
                                                    tuyệt đối.
                                                </p>
